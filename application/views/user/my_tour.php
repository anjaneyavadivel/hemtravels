...
<div class="col-xs-12 col-sm-8 col-md-9 mt-20">
							...
							<div class="dashboard-wrapper">
								...
								<h4 class="section-title">My tour</h4>
								...
								<div class="col-xs-12 col-sm-12">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-3 col-md-3">
											<div class="image">
												<img src="<?php echo base_url()?>assets/images/itinerary/02.jpg" alt="images" />
											</div>
										</div>
								...
								<div class="trip-guide-sm-item clearfix">
									...
									<div class="content">
										...
										<div class="trip-by"><span class="text-primary font22 font700 mb-1">0</span>Booking Count</div>
