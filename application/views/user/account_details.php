            ...
            <div class="col-xs-12 col-sm-9">
                <div class="itinerary-toggle-wrapper">
                    ...
                    <div class="panel-group bootstrap-toggle">
                        <?php
                        if (isset($bank) && $bank->num_rows() > 0) {
                            $i = 1;
                            foreach ($bank->result() as $v) {
                                ?>
                                <div class="panel">
        ...
        <div class="row gap-20">
            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="form-group"> 
                    ...
                    <input class="form-control" name="account_number" id="account_number" maxlength="32"  placeholder="Enter the Account Number" type="password"> 
                </div>
