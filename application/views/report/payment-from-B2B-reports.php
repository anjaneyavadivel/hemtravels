                ...
                <div class="breadcrumb-wrapper">
                    <div class="container">
                        <ol class="breadcrumb">
                            ...
                            <li  class="active"><a href="#">Payment from B2B</a></li>
                        </ol>
                    </div>
                </div>
                ...
                <div class=" container pb-50">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 pt-10 pb-5 clearfix">
                             ...
                             <?php echo form_open_multipart(base_url() . $url, array('method'=>'get','class' => 'form-horizontal margin-top-30', 'id' => 'payment-from-b2b-report-form')); ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-lg-12">
                                    <a class="btn btn-info  col-lg-1 col-sm-1 col-lg-1" id="b2bFromExportXLSX">Export</a>
