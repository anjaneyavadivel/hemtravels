    ...
    <div class="row gap-20">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in active" id="link" name="attributes" role="tabpanel">
                ...
                <textarea class="form-control show_share_html" style="margin-top:20px;display:none;"><a class="btn btn-primary" href="<?php echo base_url('trip-view/'.$tripCode)?>" target="_blank">Share</a></textarea>
