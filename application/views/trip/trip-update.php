...
<!--                                            <h4 class="section-title">About this tour</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 mb-15">
                                                    ...
                                                    <label>Is allow Child:</label>
                                                     <div class="radio-block">
                                                        <input  id="is_allow_child_1" name="is_allow_child" type="radio" class="radio" value="1" <?php echo isset($trip_details['details']['is_allow_child']) && $trip_details['details']['is_allow_child']==1?'checked':''?>/>
                                                        <label class="" for="is_allow_child_1">Yes</label>
                                                    </div>				
                                                    <div class="radio-block">
                                                        <input  id="is_allow_child_2" name="is_allow_child" type="radio" class="radio" value="0" <?php echo isset($trip_details['details']['is_allow_child']) && $trip_details['details']['is_allow_child']==0?'checked':''?>/>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-6 mb-15">
                                                    ...
                                                    <div class="radio-block">
                                                        <input  id="is_allow_infan_1" name="is_allow_infan" type="radio" class="radio" value="1" <?php echo isset($trip_details['details']['is_allow_infan']) && $trip_details['details']['is_allow_infan']==1?'checked':''?>/>
                                                        <label class="" for="is_allow_infan_1">Yes</label>
                                                    </div>				
                                                    <div class="radio-block">
                                                        <input  id="is_allow_infan_2" name="is_allow_infan" type="radio" class="radio" value="0" <?php echo isset($trip_details['details']['is_allow_infan']) && $trip_details['details']['is_allow_infan']==0?'checked':''?>/>
                                            ...
                                            <div class="row gap-50"  style="margin: 0 -15px;">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 hide" id="how_many_daysdiv">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 hide" id="how_many_hoursdiv">
                                                    <div class="row gap-20">
                                                        <div class="col-xsw-12 col-xs-6 col-sm-6 col-md-6">
                                                            <div class="form-group form-spin-group">
                                                ...
                                                <div class="pickup_location_list_div">
                                                    ...
                                                    <div class="pickup_location_list_default" id="pickup_location_list_0">
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-15 col-xs-12 col-sm-<?php echo $col1;?>">
                                                            ...
                                                            <div class="mb-15 col-xs-12 col-sm-3">
                                                            ...
                                                            <div class="mb-15 col-xs-12 col-sm-<?php echo $col3;?>">
