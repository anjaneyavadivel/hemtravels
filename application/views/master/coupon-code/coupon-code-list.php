                            ...
                            <div class="col-xs-10 col-sm-10 col-lg-10">
                                <div class="form-group">
                                    ...
                                    <div class="row gap-0">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-2">
                                            <select name="type" class="selectpicker show-tick form-control" title="Select placeholder">
                                                <option value="">All</option>
                                                <option value="1" <?php if($offer_type==1){echo 'selected';}?>>Customer</option>
                                                <option value="2" <?php if($offer_type==2){echo 'selected';}?>>Vendor</option>
                                                 <?php  if ($this->session->userdata('user_type') == 'SA') {  ?>
                                                <option value="3" <?php if($offer_type==3){echo 'selected';}?>>Super Admin Alter</option>
                                                 <?php  }?>
                                            </select>
                                        </div>
