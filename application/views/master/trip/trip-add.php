<div class="modal-header">
    ...
    <h4 class="modal-title text-center">Add trip</h4>
</div>
<?php echo form_open_multipart(base_url() . 'trip-inclusions-master/add', array('class' => 'form-horizontal margin-top-30', 'id' => 'add-trip-form')); ?>
