                ...
                <div class="breadcrumb-wrapper">
                    <div class="container">
                        <ol class="breadcrumb">
                            ...
                            <li  class="active"><a href="#">trip Master</a></li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 pt-10 pb-5 clearfix">
                            ...
                            <div class="col-xs-10 col-sm-10 col-lg-6">
                                <div class="form-group">
                                    <label>Search</label>
                                    <div class="row gap-0">
                                        <?php echo form_open_multipart(base_url() . 'trip-inclusions-master', array('class' => 'form-horizontal margin-top-30', 'id' => 'search-trip-form')); ?>

                                        <div class="col-xs-9 col-sm-10 col-md-10">
                                            <input type="text" name="trip_search" class="form-control" placeholder="Enter trip name" value="<?=$trip_search?>">
                                        </div>
                                    ...
                                    <tr>
                                       ...
                                       <?php if($isactive!='0'){?> 
                                        <td><a class="<?=$btn_type[$val];?> btn-edit-trip" data-val="<?=$id?>" ><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="Click here to edit"></i></a>
                                            <a href="<?=base_url();?>trip-inclusions-master/delete/<?=$id?>"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="Click here to delete"></i> </a></td><?php }?>
										<?php if($isactive!='1'){?><td><a href="<?=base_url();?>trip-inclusions-master/active/<?=$id?>" class="<?=$btn_type[$val];?>"><i class="fa fa-check" data-toggle="tooltip" data-placement="top" title="Click here to active"></i></a><?php }?>
