									...
									<div class="promo-box-02 bg-primary mb-40 pb-50">
										...
										<div class="col-xs-12 col-sm-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" placeholder="Enter the PNR number" id="pnr_number"/>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-4">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" placeholder="Enter the phone number" id="phone_number"/>
                                                                                </div>

                                                                            </div>

                                                                            <div class="col-xs-12 col-sm-2">
                                                                                <button class="btn btn-success check_status">Check Status</button>
                                                                            </div>                                                                            
									</div>
                                                                    <div class="check_error" style="color:red;display:none;">Enter the PNR number and Phone number</div>
                                                                    
                                                                    <div class="pnr_details" style="display:none;">
                                                                            ...
                                                                            <ul class="book-sum-list mt-30">
                                                                                <li><span class="font600 pnr_number">PNR Number:</span></li>
                                                                                   <!-- <li><span class="font600 traveller_name">Traveller Name: </span></li>-->
                                                                                    <li><span class="font600 package_name">Package Name:</span></li>
                                                                                    <li><span class="font600 no_of_traveller">No Of Traveller:</span></li>
                                                                                    <li><span class="font600 net_price">Total Amount:</span></li>                                                                                    
                                                                                    <!--<li><span class="font600">Starting: </span> <span class="starting"></span></li>
                                                                                    <li><span class="font600">End: </span><span class="end"></span></li>
                                                                                    <li><span class="font600">Included: </span><span class="included"></span></li>
                                                                                    <li><span class="font600">Excluded: </span><span class="excluded"></span></li>-->
                                                                                    <li><span class="font600 billed_by">Billing By:</li>
                                                                                    <li><span class="font600 billed_add">Billing Address:</li>
                                                                                    <li><span class="font600 billed_email">Billing Email:</li>
                                                                                    <li><span class="font600 billed_phone_number">Phone Number:</li>
                                                                            </ul>
                                                                            ...
                                                                            <ul class="list-with-icon list-inline-block">
                                                                                <li><i class="ri-microphone text-primary"></i> <strong class="vendor_phone">Hotline:</strong></li>
                                                                                    <li><i class="ri ri-envelope text-primary"></i> <strong class="vendor_email">Email:</strong></li>
