...
class Report extends CI_Controller {
	...
	public function category_list($booking_search = '') {
        ...
        $config = array();
        $config["base_url"] = base_url() . "booking-wise-reports/" . $booking_search; //?search=".$category_search
    ...
    public function loadmodal($view) {
        if ($view != "") {
            ...
            $this->load->view("report/booking/$view", $data);
        } else {
            echo "Error";
        }
    }
